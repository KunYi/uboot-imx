...
#define CONFIG_DEFAULT_FDT_FILE	"imx6qp-tinto-evt.dtb"
#define PHYS_SDRAM_SIZE		(1u * 1024 * 1024 * 1024)
#elif defined(CONFIG_MX6Q)
#define CONFIG_DEFAULT_FDT_FILE	"imx6q-tinto-evt.dtb"
#define PHYS_SDRAM_SIZE		(1u * 1024 * 1024 * 1024)
#elif defined(CONFIG_MX6DL)
#define CONFIG_DEFAULT_FDT_FILE	"imx6dl-tinto-evt.dtb"
#define PHYS_SDRAM_SIZE		(1u * 1024 * 1024 * 1024)
...
#define CONFIG_DEFAULT_BOARDREV \
	"boardrev=MP\0" \
	"hwrev=0\0" \
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"usbargs=setenv bootargs console=${console},${baudrate} ${smp} " \
		"root=${usbroot} video=${videoargs}\0" \
	"loadbootscript=" \
	...
	"loadusbimage=fatload usb ${usbdev}:${usbpart} ${loadaddr} ${image}\0" \
	"loadusbfdt=fatload usb ${usbdev}:${usbpart} ${fdt_addr} ${fdt_file}\0" \
	...
	"upgrade_uboot=" \
		...
		"echo reflash u-boot finish,will reboot now; " \
		"reset;\0"
